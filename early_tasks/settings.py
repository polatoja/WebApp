"""
Django settings for early_tasks project.
...
SECRET_KEY = 'django-insecure-1e7%z5(5ca&13d!ski=njn$_q482^32igip5pgj4$li5s)wn44'
...
WSGI_APPLICATION = 'early_tasks.wsgi.application'
...
# Logginh user out after session ends
